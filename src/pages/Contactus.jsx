    ...
    return (
        <div className=''>
            ...
            <div style={{
                ...
                <>
                    At MetaDatAnSol , our mission is to empower businesses of all sizes to harness the full potential of their data. We specialize in a wide range of Business Intelligence and custom software solutions, enabling you to make informed decisions and implement data-driven strategies swiftly.
